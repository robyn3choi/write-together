...
export let lensHub: ethers.Contract | null = null

export function setSigner(newSigner: ethers.providers.JsonRpcSigner) {
  signer = newSigner
  lensHub = new ethers.Contract(process.env.NEXT_PUBLIC_LENS_HUB_CONTRACT!, LENS_HUB_ABI, signer)
  console.log('new lenshub', lensHub)
}
